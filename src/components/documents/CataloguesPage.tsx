...
import { Search, Plus, Filter, Download, FileText, Clock, Tag, User, Calendar, FileBarChart } from 'lucide-react';
...
const CataloguesPage: React.FC = () => {
  ...
  const catalogues: Catalogue[] = [
    {
      id: '1',
      title: 'Complete Product Catalogue 2024',
      documentNumber: 'CAT-001',
      version: '2.3',
      status: 'active',
      ...
      category: 'Product',
      language: 'English',
      tags: ['Complete', 'Product', '2024']
    },
    {
      id: '2',
      title: 'Premium Chocolate Collection Catalogue',
      documentNumber: 'CAT-002',
      version: '1.5',
      status: 'active',
      ...
      category: 'Product',
      language: 'English',
      tags: ['Premium', 'Chocolate', 'Collection']
    },
    {
      id: '3',
      title: 'Seasonal Products Catalogue - Spring 2024',
      documentNumber: 'CAT-003',
      version: '3.1',
      status: 'draft',
      ...
      category: 'Seasonal',
      language: 'English',
      tags: ['Seasonal', 'Spring', '2024']
    },
    {
      id: '4',
      title: 'Packaging Solutions Catalogue',
      documentNumber: 'CAT-004',
      version: '1.2',
      status: 'active',
      ...
      category: 'Packaging',
      language: 'English',
      tags: ['Packaging', 'Solutions', 'Options']
    },
    {
      id: '5',
      title: 'Specialty Products Catalogue',
      documentNumber: 'CAT-005',
      version: '2.0',
      status: 'archived',
      ...
      category: 'Specialty',
      language: 'English',
      tags: ['Specialty', 'Limited', 'Exclusive']
    }
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold mb-1">Catalogues</h1>
          <p className="text-[var(--text-secondary)]">
            Manage product and service catalogues
          </p>
        </div>
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="flex flex-col items-end">
                  <span className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(catalogue.status)}`}>
