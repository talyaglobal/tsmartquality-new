...
import { Search, Plus, Filter, Download, FileText, Clock, Tag, User, Calendar, Braces } from 'lucide-react';
...
const FlowChartPage: React.FC = () => {
  ...
  const flowCharts: FlowChart[] = [
    {
      id: '1',
      title: 'Chocolate Production Process Flow',
      ...
      process: 'Production',
      tags: ['Production', 'Chocolate', 'Process']
    },
    {
      id: '2',
      title: 'Packaging Process Flow',
      documentNumber: 'FC-002',
      version: '1.5',
      status: 'active',
      lastUpdated: '2024-02-20',
      updatedBy: 'Sarah Johnson',
      process: 'Packaging',
      tags: ['Packaging', 'Process', 'Workflow']
    },
    {
      id: '3',
      title: 'Quality Control Process Flow',
      documentNumber: 'FC-003',
      version: '3.1',
      status: 'draft',
      lastUpdated: '2024-03-10',
      updatedBy: 'Michael Brown',
      process: 'Quality Control',
      tags: ['QC', 'Process', 'Inspection']
    },
    {
      id: '4',
      title: 'Warehouse Receiving Process Flow',
      documentNumber: 'FC-004',
      version: '1.2',
      status: 'active',
      lastUpdated: '2024-01-15',
      updatedBy: 'Emily Davis',
      process: 'Warehouse',
      tags: ['Warehouse', 'Receiving', 'Logistics']
    },
    {
      id: '5',
      title: 'Product Development Process Flow',
      documentNumber: 'FC-005',
      version: '2.0',
      status: 'archived',
      lastUpdated: '2023-12-05',
      updatedBy: 'John Smith',
      process: 'R&D',
      tags: ['R&D', 'Development', 'Innovation']
    }
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold mb-1">Process Flow Charts</h1>
          <p className="text-[var(--text-secondary)]">
            Manage process flow charts and diagrams
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select className="w-full border border-[var(--divider)] rounded-md p-2">
                  ...
                  <option value="value">Value Stream Map</option>
                </select>
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">
