...
import { ArrowDownToLine, ArrowUpFromLine, RefreshCw, Settings, Link2, CheckCircle, XCircle, AlertCircle, DollarSign, FileText, Box, BookOpenCheck, Truck, Users } from 'lucide-react';
...
const TSmartBooksPage: React.FC = () => {
  ...
  const recentSyncs: SyncStatus[] = [
    ...
    },
    {
      ...
      status: 'error',
      recordsProcessed: 23,
      message: 'Failed to sync 2 POs due to missing supplier information'
    },
    {
      id: '3',
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold mb-1">TSmartBooks Integration</h1>
          <p className="text-[var(--text-secondary)]">
            Manage data synchronization with TSmartBooks accounting system
          </p>
        </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[var(--text-secondary)]">
                          {mapping.direction === 'push' ? 'Push to TSmartBooks' :
                           mapping.direction === 'pull' ? 'Pull from TSmartBooks' :
                           'Two-way Sync'}
                        </p>
                      </div>
                    </div>
...
export default TSmartBooksPage;