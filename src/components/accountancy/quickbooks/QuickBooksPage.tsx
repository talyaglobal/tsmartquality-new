...
import { ArrowDownToLine, ArrowUpFromLine, RefreshCw, Settings, Link2, CheckCircle, XCircle, AlertCircle, DollarSign, FileText, Box, Calculator } from 'lucide-react';
...
const QuickBooksPage: React.FC = () => {
  ...
  const recentSyncs: SyncStatus[] = [
    ...
    },
    {
      ...
      status: 'error',
      recordsProcessed: 23,
      message: 'Failed to sync 2 expenses due to missing categories'
    },
    {
      id: '3',
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold mb-1">QuickBooks Integration</h1>
          <p className="text-[var(--text-secondary)]">
            Manage data synchronization with QuickBooks Online
          </p>
        </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[var(--text-secondary)]">
                          {mapping.direction === 'push' ? 'Push to QuickBooks' :
                           mapping.direction === 'pull' ? 'Pull from QuickBooks' :
                           'Two-way Sync'}
                        </p>
                      </div>
                    </div>
