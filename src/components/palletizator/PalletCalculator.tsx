...
const PalletCalculator: React.FC = () => {
  ...
  // 100x120 Euro pallet configuration
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold mb-1">100x120 Pallet Calculator</h1>
        <p className="text-[var(--text-secondary)]">
          Calculate optimal box arrangement for a 100x120 Euro pallet
        </p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-[var(--background-default)] rounded-lg">
              ...
              {layout.isOverweight && (
                <p className="text-sm text-[var(--error-main)] mt-2">
                  Warning: Exceeds maximum weight limit of {unit === 'metric' ? '1000 kg' : '2204.62 lb'}
                </p>
              )}
            </div>
            ...
            <div className="border-t border-[var(--divider)] pt-4">
              ...
              <ul className="space-y-2 text-sm text-[var(--text-secondary)]">
                <li>• Dimensions: 100 x 120 cm ({convertToImperial(100, 'length')} x {convertToImperial(120, 'length')} in)</li>
