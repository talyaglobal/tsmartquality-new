...
interface ProductPhotoUploadModalProps {
  onClose: () => void;
  onUpload: (files: File[], metadata: any) => void;
}

const ProductPhotoUploadModal: React.FC<ProductPhotoUploadModalProps> = ({ onClose, onUpload }) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            <p className="mt-2 text-sm text-[var(--text-secondary)]">
              {isDragActive ? 'Drop the files here' : 'Drag & drop product photos here, or click to select'}
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Input
              ...
              onChange={(e) => setMetadata({ ...metadata, productCode: e.target.value })}
              required
            />
          </div>
          ...
          <Input
            ...
            placeholder="e.g., product, front-view, packaging"
          />
...
export default ProductPhotoUploadModal;