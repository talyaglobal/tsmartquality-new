...
import { Eye, Download, Trash2, Edit, Box } from 'lucide-react';
...
const BoxPhotoGrid: React.FC = () => {
  // Sample data - replace with actual data from your API
  const photos: BoxPhoto[] = [
    {
      id: '1',
      url: 'https://images.pexels.com/photos/4483610/pexels-photo-4483610.jpeg',
      title: 'Product Box Front View',
      type: 'jpg',
      boxType: 'Primary Packaging',
      view: 'Front',
      size: '2.4 MB',
    ...
    },
    {
      ...
      title: 'Shipping Box 3D View',
      type: 'png',
      boxType: 'Shipping Box',
      view: '3D',
      size: '3.1 MB',
  ...
  const handleView = (photo: BoxPhoto) => {
    console.log('View photo:', photo);
  };

  const handleDownload = (photo: BoxPhoto) => {
    console.log('Download photo:', photo);
  };

  const handleEdit = (photo: BoxPhoto) => {
    console.log('Edit photo:', photo);
  };

  const handleDelete = (photo: BoxPhoto) => {
          ...
          <div className="p-4">
            ...
            <div className="text-sm text-[var(--text-secondary)] space-y-1">
              <div className="flex justify-between">
                <span>Box Type:</span>
                <span className="font-medium">{photo.boxType}</span>
              </div>
              <div className="flex justify-between">
                <span>View:</span>
