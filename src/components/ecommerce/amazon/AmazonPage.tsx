...
const AmazonPage: React.FC = () => {
  ...
  const recentSyncs: SyncStatus[] = [
    ...
    },
    {
      ...
      status: 'error',
      recordsProcessed: 23,
      message: 'Failed to sync inventory for 2 SKUs'
    },
    {
      id: '3',
      type: 'Orders',
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold mb-1">Amazon Integration</h1>
          <p className="text-[var(--text-secondary)]">
            Manage data synchronization with Amazon Marketplace
          </p>
        </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[var(--text-secondary)]">
                          {mapping.direction === 'push' ? 'Push to Amazon' :
                           mapping.direction === 'pull' ? 'Pull from Amazon' :
                           'Two-way Sync'}
                        </p>
                      </div>
                    </div>
