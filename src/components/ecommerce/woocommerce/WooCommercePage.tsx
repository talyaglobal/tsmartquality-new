  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold mb-1">WooCommerce Integration</h1>
          <p className="text-[var(--text-secondary)]">
            Manage data synchronization with your WooCommerce store
          </p>
        </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[var(--text-secondary)]">
                          {mapping.direction === 'push' ? 'Push to WooCommerce' :
                           mapping.direction === 'pull' ? 'Pull from WooCommerce' :
                           'Two-way Sync'}
                        </p>
                      </div>
                    </div>
